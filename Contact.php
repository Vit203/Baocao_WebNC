...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        Customers may forget what you do, but they'll never forget how you felt
        </p>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <h5>Address</h5>
                    <a href="<?php echo $contact_r['gmap'] ?>" target="_blank" class="d-inline text-decoration-none text-dark mb-2">
            ...
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="m3-3">
                            <label class="form-label" style="font-weight: 500;">Content</label>
